...
export class GitHubClient extends Context.Service<GitHubClient, {
  ...
  private static layerWithPermissions(
    permissions: {
  ...
  static readonly layer = GitHubClient.layerWithPermissions({
    issues: "write",
  });
  static readonly metricsLayer = GitHubClient.layerWithPermissions({
    issues: "read",
    pull_requests: "read",
  });
}
